...
class Kconfig(object):
    ...
    def _format_sym_to_define(self, sym, list):
        ...
        if sym.nodes[0].help:
            if _NO_PREFIX in sym.nodes[0].help.lower():
                updated_config_prefix = sym.kconfig.config_prefix.replace(sym.kconfig.config_prefix, "")
            else:
        ...
        if sym.orig_type in _BOOL_TRISTATE:
            ...
            if val == "y":
                list.append("#define {}{} 1\n"
                                 .format(updated_config_prefix, sym.name))
            elif val == 'n':
                list.append("#define {}{} 0\n"
                            .format(updated_config_prefix, sym.name))
            elif val == "m":
                list.append("#define {}{}_MODULE 1\n"
                                 .format(updated_config_prefix, sym.name))
            ...
            list.append("#define {}{} {}\n"
                             .format(updated_config_prefix, sym.name, val))
