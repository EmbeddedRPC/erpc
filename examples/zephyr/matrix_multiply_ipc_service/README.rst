.. _matrix_multiply_ipc_service:

Matrix multiply IPC Service
###########

The eRPC Matrix multiply IPC Service sample that can be used with: :ref:`supported board <boards>`.
...
printed out to the serial console by the primary core. IPC Service erpctransport layer is used in
...
.. zephyr-app-commands::
   :zephyr-app: samples/matrix_multiply_ipc_service
