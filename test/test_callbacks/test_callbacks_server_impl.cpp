...
public:
    int32_t myFun(const callback1_t pCallback1_in, callback1_t *pCallback1_out)
    {
        ...
        if (findIndexOfFunction((arrayOfFunctionPtr_t)::_callback1_t, sizeof(::_callback1_t) / sizeof(::callback1_t),
                                (functionPtr_t)_pCallback1_out, _fnIndex))
        {
    ...
    void myFun2(const ClientCore1Services_interface::callback2_t pCallback2_in,
                ClientCore1Services_interface::callback2_t *pCallback2_out)
    {
        uint16_t _fnIndex;
        ...
        if (findIndexOfFunction((arrayOfFunctionPtr_t)::_callback2_t, sizeof(::_callback2_t) / sizeof(::callback2_t),
                                (functionPtr_t)_pCallback2_out, _fnIndex))
        {
    ...
    void callback1a(int32_t a, int32_t b) { ::callback1a(a, b); }

    void callback1b(int32_t param1, int32_t param2) { ::callback1b(param1, param2); }
};
