...
use crate::generator::python::templates::util::{ decode_type, encode_type, format_function_prototype_py, format_param_name, optional_indent, format_inner_parameters_py };
use crate::generator;
...
#[derive(Template)]
#[template(path = "python/py_server.askama")]
pub struct PyServerTemplate {
    pub date: String,
...
pub struct PyServerTemplateBuilder {
    date: String,
